...
class BinarySearchTree:
    ...
    def delete(self, target):
        ...
        #delete node with two children
            ...
            #find succusor by finding the minimum on the right side of the current node
            ...
            if succesor_parent.left == succesor:
                ...
                succesor_parent.right = succesor.left
...
# Before inversion
is_a_valid_binary_tree =bst.is_valid_tree()
